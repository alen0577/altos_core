...
def accounts_designation(request):
    if 'usernameacnt2' in request.session:
        ...
        dept_id = request.GET.get('dept_id')
        Desig = designation.objects.filter(~Q(designation="admin"),~Q(designation="manager"),~Q(designation="project manager"),~Q(designation="tester"),~Q(designation="trainingmanager"),~Q(designation="trainer"),~Q(designation="trainee"),~Q(designation="accountant"),~Q(designation="hr"))
